...
const GREETER_CONTRACT_ADDRESS = "0x8b6E8186dE74fe0128C0a6a3B2733c1365f4c9e2";
// eslint-disable-next-line
...
export default {
  ...
  methods: {
    async initializeProviderAndSigner() {
      ...
      console.log("signer info:", this.signer);
      this.contract = new Contract(
          GREETER_CONTRACT_ADDRESS,
          GREETER_CONTRACT_ABI,
          this.signer
      );
      console.log("initialized provider and signer");
    },
    async getGreeting() {
      console.log("called greet() ------ ");
      // console.log("contract: ", await this.provider.getCode(GREETER_CONTRACT_ADDRESS));
      // Smart contract calls work the same way as in `ethers`
      // const newMessage = "Eva!";
      // return await this.contract.setGreeting(newMessage);
